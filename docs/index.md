...
-   :material-pencil: **练习与评估**
    ...
    手算公式、构造反例、设计对照，并用答案解析检查证据边界。

    [进入练习册](exercises/index.md)
...
只阅读文档容易产生“熟悉感错觉”；只运行代码容易变成看绿色对勾。课程、实验与练习必须一起使用。
...
开始：[课程导览](course/index.md) · [实验手册](labs/index.md) · [练习册](exercises/index.md)
